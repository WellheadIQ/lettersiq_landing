...
export const storyChapters = [
  {
    ...
    camera: {
      position: [0.2, 5.3, 13.0],
      target: [0.15, 1.6, 0.1],
      fov: 34,
      mobile: { position: [0.2, 6.2, 15.6], fov: 46 },
    },
  ...
  },
  {
    ...
    camera: {
      position: [3.4, 4.35, 6.9],
      target: [1.28, 3.3, -0.3],
      fov: 33,
      mobile: { position: [3.9, 4.7, 8.6], fov: 44 },
    },
  ...
  },
  {
    ...
    camera: {
      position: [0, 1.75, 8.05],
      target: [0, 1.2, 3.05],
      fov: 29,
      mobile: { position: [0, 1.85, 8.8], fov: 42 },
    },
  ...
  },
  {
    ...
    camera: {
      position: [0, 1.95, 8.15],
      target: [0, 1.2, 3.05],
      fov: 31,
      mobile: { position: [0, 2.05, 9.4], fov: 44 },
    },
